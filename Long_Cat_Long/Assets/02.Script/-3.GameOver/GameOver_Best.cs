...
public class GameOver_Best : MonoBehaviour
{
    //점수호출변수
	...
	void Start ()
    {
        ...
        {
            Score_img[i] = Instantiate(Score_Prefab, 
                new Vector3(transform.position.x - 40*i, transform.position.y, 0f), Quaternion.identity);
